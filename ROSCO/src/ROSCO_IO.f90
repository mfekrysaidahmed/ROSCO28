! ROSCO IO
! This file is automatically generated by write_registry.py using ROSCO v2.3.0
...
SUBROUTINE WriteRestartFile(LocalVar, CntrPar, ErrVar, objInst, RootName, size_avcOUTNAME)
    ...
    ELSE
        ...
        WRITE( Un, IOSTAT=ErrStat) LocalVar%YawErr
        ...
        WRITE( Un, IOSTAT=ErrStat) LocalVar%BlPitch_OpenfAST(1)
        WRITE( Un, IOSTAT=ErrStat) LocalVar%BlPitch_OpenfAST(2)
        WRITE( Un, IOSTAT=ErrStat) LocalVar%BlPitch_OpenfAST(3)
...
SUBROUTINE ReadRestartFile(avrSWAP, LocalVar, CntrPar, objInst, PerfData, RootName, size_avcOUTNAME, zmqVar, ErrVar)
    ...
    ELSE
        ...
        READ( Un, IOSTAT=ErrStat) LocalVar%YawErr
        ...
        READ( Un, IOSTAT=ErrStat) LocalVar%BlPitch_OpenfAST(1)
        READ( Un, IOSTAT=ErrStat) LocalVar%BlPitch_OpenfAST(2)
        READ( Un, IOSTAT=ErrStat) LocalVar%BlPitch_OpenfAST(3)
...
! Debug routine, defines what gets printed to DEBUG.dbg if LoggingLevel = 1
    ...
    LocalVarOutStrings = [CHARACTER(15) ::  'iStatus', 'Time', 'DT', 'VS_GenPwr', 'GenSpeed', & 
                                      'RotSpeed', 'NacHeading', 'NacVane', 'HorWindV', 'YawErr', & 
                                      'rootMOOP', 'rootMOOPF', 'BlPitch', 'BlPitch_OpenfAST', 'BlPitchCMeas', & 
