...
TYPE, PUBLIC :: ControlParameters
    ...
    INTEGER(IntKi)                :: SD_Mode                     ! Shutdown mode {0 - no shutdown procedure, 1 - pitch to max pitch at shutdown, 2- Yaw cutout, 3- Max. blade pitch misaligment, 4- 1 and 2, 5- 1 and 3, 6- 2 and 3, 7- all}
    ...
    REAL(DbKi)                    :: SD_MaxYaw_Cutout            ! Maximum Yaw cutout to initiate shutdown [rad], {default = 30 deg.}
    REAL(DbKi)                    :: SD_MaxBlade_Ptch_Misalign   ! Maximum blade pitch misaligment angle to initiate shutdown [rad], {default = 3 deg.}
...
TYPE, PUBLIC :: LocalVariables
    ...
    REAL(DbKi)                    :: YawErr                      ! (Wind Direction - Yaw Angle) radians
    ...
    REAL(DbKi)                    :: BlPitch_OpenfAST(3)         ! Blade pitch imported from OpenFAST[rad]
